    ...
    otherTabIdx(-1)
{
    ...
    colorsGrid->addWidget(createSpacer(colorsGrp), int(itemList.count()) - offset, 1);
    ...
    offset = endOfActiveColors = int(itemList.count());
    ...
    colorsGrid->addWidget(createSpacer(normalInactiveWidget), int(itemList.count()) - offset, 1);
    ...
    offset = endOfPanelColors = int(itemList.count());
    ...
    int index = int(itemList.count()) - offset;
    ...
    colorsGrid->addWidget(createSpacer(dimmedInactiveWidget), int(itemList.count()) + 1 - offset, 1);
