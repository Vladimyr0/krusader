...
{
    buttonList << setup(mainWindow->listPanelActions()->actTerminalF9, i18n("Term")) << setup(mainWindow->listPanelActions()->actViewFileF3, i18n("View"))
               ...
               << setup(mainWindow->listPanelActions()->actDeleteF8, i18n("Delete")) << setup(mainWindow->listPanelActions()->actRenameF2, i18n("Rename"))
